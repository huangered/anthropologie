/*
 * cmdatatagutils.js 
 * $Id: cmdatatagutils.js,v 1.3 2011/04/29 03:56:07 sakp Exp $
 * $Revision: 1.3 $
 *
 * Version 4.1.0
 *
...
cm_JSFPCookieDomain = "anthropologie.eu";
}
...
function cmCreateProductviewTag(productID, productName, categoryID,attributes) {
	...
	if(typeof(cmCurrentLanguage)=="undefined") cmCurrentLanguage="";
	cmMakeTag(["tid","5","pi",cmCurrentLanguage+"PRODUCT: "+productName+" ("+productID+")","pr",productID,"pm",productName,"cg",categoryID,"pc","Y","cm_vc",cmExtractParameter("cm_vc",document.location.href),"cm_exAttr",cm_exAttr]);
}
...
function cmCreateShopAction5Tag(productID,productName,productQuantity,productPrice,categoryID,attributes) {
	...
	cmAddShop(["pr",productID,"pm",productName,"qt",productQuantity,"bp",productPrice,"cg",categoryID,"cc",cm_currencyCode,"ha1",attributes ? cm_hex_sha1(attributes) : null,"at","5","tid","4","pc","N"]);
}
...
function cmCreateShopAction9Tag(productID,productName,productQuantity,productPrice,customerID,orderID,orderTotal,categoryID,attributes) {
	...
	cmAddShop(["pr",productID,"pm",productName,"qt",productQuantity,"bp",productPrice,"cg",categoryID,"cc",cm_currencyCode,"ha1",attributes ? cm_hex_sha1(attributes) : null,"cd",customerID,"on",orderID,"tr",orderTotal,"at","9","tid","4","pc","N"]);
	cmCalcSKUString();
}
...
// added as a block to order and shop tags
