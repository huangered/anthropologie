...
Venda.Widget.RegionLangSwitch.createDialog =  function(selectedObj){
	...
	/*Quick hack to get current currency and language options to pre select*/
 	var rlsLocation = ".currency span." + Venda.Ebiz.CookieJar.get("locn") + " a";
	var rlsLanguage = ".contentLlanguage .region a[rel=" + Venda.Ebiz.CookieJar.get("lang") + "]";
	jQuery(rlsLocation).addClass("selected");
	jQuery(rlsLanguage).addClass("selected");
